...
//using that number,we will get a random NFT from three fixed NFT
// 1 super rare,2 sort of rare,3 common
...
error RandomIpfsNft__RangOutOfBounds();
...
contract RandomIpfsNft is VRFConsumerBaseV2, ERC721URIStorage, Ownable {
        ...
        override
    {
        ...
        Breed dogBreed = getBreedFromModdedRng(modderRng);
        ...
        returns (Breed)
    {
        ...
        revert RandomIpfsNft__RangOutOfBounds();
    }
